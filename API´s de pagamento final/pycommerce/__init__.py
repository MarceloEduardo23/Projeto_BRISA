...
class EmailService:
    """Gerencia o envio de e-mails transacionais."""
...
class MercadoPagoService:
    """Gerencia as integrações com o Mercado Pago."""
    ...
    def create_payment_preference(self, items, payer_email, payment_method='all'):
        ...
        preference_data = {
            "items": items,  # Espera uma lista de dicionários com: title, quantity, unit_price
...
class PayPalService:
    """Gerencia as integrações com o PayPal."""
    ...
    def _get_access_token(self):
        """Obtém um token de acesso do PayPal."""
    ...
    def create_order(self, total_value, currency="USD"):
        """Cria uma ordem de pagamento no PayPal e retorna o link de aprovação."""
    ...
    def capture_order(self, order_id):
        """Captura o pagamento de uma ordem previamente aprovada."""
        token = self._get_access_token()
...
class StripeService:
    """Gerencia as integrações com o Stripe."""
    ...
    def create_checkout_session(self, line_items, customer_email):
        ...
        'line_items' deve ser uma lista de dicionários, cada um contendo:
        {'name': str, 'quantity': int, 'unit_price': float, 'currency': str}
        """
        formatted_items = []
